...
* 빌드 - 아래 링크에서 Zip파일 다운로드

https://github.com/happy124210/Aero-Diner/releases/tag/v0.1.1
...
기본 제공되는 토마토 파스타 레시피북을 공개합니다! 

후반기에 개발될 일상 파트에서는 더 다양한 레시피를 해금할 수 있는 퀘스트와 상점이 추가될 예정입니다.
